  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const [
        ...
        supabase.from('stock_items').select('*').eq('active', true).order('catalog_order', { ascending: true }), // stock_items
