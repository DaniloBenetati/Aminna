    ...
    return (
        <div className="flex h-full gap-4 p-4 pb-20 md:p-4 font-sans">
            ...
            <div className="flex-1 flex flex-col space-y-4 min-w-0">
                ...
                <div className="flex flex-col xl:flex-row justify-between items-start xl:items-center gap-4 bg-white dark:bg-zinc-900 p-4 rounded-sm border border-slate-200 dark:border-zinc-800 shadow-sm transition-colors">
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-3 w-full xl:w-auto">
                        ...
                        {timeView === 'custom' ? (
                            ...
                            <div className="flex items-center gap-2 bg-slate-50 dark:bg-zinc-800 border-2 border-slate-100 dark:border-zinc-700 px-2 py-1.5 rounded-sm w-full md:w-auto justify-between md:justify-start">
                                <button onClick={() => navigateDate('prev')} className="p-2 hover:bg-white dark:hover:bg-zinc-700 rounded-sm text-slate-400 hover:text-slate-900 dark:hover:text-white transition-colors"><ChevronLeft size={16} /></button>
                                <div className="flex flex-col items-center min-w-[140px]">
                                    <span className="text-[10px] font-black text-slate-950 dark:text-white uppercase tracking-tight">{getDateLabel()}</span>
                                </div>
                                <button onClick={() => navigateDate('next')} className="p-2 hover:bg-white dark:hover:bg-zinc-700 rounded-sm text-slate-400 hover:text-slate-900 dark:hover:text-white transition-colors"><ChevronRight size={16} /></button>
                            </div>
                        )}
                    </div>
                    ...
                    <div className="flex flex-wrap gap-3 w-full xl:w-auto items-center">
                        <div className="relative flex-1 md:min-w-[200px]">
                            ...
                            <select
                                ...
                                className="w-full pl-9 pr-4 py-3 bg-slate-50 dark:bg-zinc-800 border-2 border-slate-200 dark:border-zinc-700 rounded-sm text-[10px] font-black text-slate-900 dark:text-white outline-none focus:border-indigo-500 uppercase appearance-none"
                        ...
                        <div className="relative flex-1 md:min-w-[200px]">
                            ...
                            <input
                                ...
                                className="w-full pl-9 pr-4 py-3 bg-slate-50 dark:bg-zinc-800 border-2 border-slate-200 dark:border-zinc-700 rounded-sm text-[10px] font-black text-slate-900 dark:text-white outline-none focus:border-indigo-500"
                                value={searchTerm}
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 bg-emerald-500 hover:bg-emerald-600 text-white px-5 py-3 rounded-sm text-[10px] font-black uppercase tracking-widest shadow-lg active:scale-95 transition-all"
                        >
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 bg-zinc-950 dark:bg-white text-white dark:text-zinc-950 px-5 py-3 rounded-sm text-[10px] font-black uppercase tracking-widest shadow-lg active:scale-95 transition-all"
                        >
                    ...
                    <div className="flex border-b border-slate-100 dark:border-zinc-800 bg-slate-50/50 dark:bg-zinc-800/30">
                        ...
                        <div className="flex items-center gap-1 px-3 border-l border-slate-200 dark:border-zinc-800">
                            <button
                                ...
                                className="p-1.5 hover:bg-white dark:hover:bg-zinc-800 rounded-sm text-slate-400 hover:text-slate-900 dark:hover:text-white transition-all border border-transparent hover:border-slate-200"
                            ...
                            <button
                                ...
                                className="p-1.5 hover:bg-white dark:hover:bg-zinc-800 rounded-sm text-slate-400 hover:text-slate-600 transition-all"
                                    ...
                                    for (let day = 1; day <= daysInMonth; day++) {
                                        ...
                                        days.push(
                                            <div
                                                ...
                                                className={`relative group bg-white dark:bg-zinc-900 border ${isToday ? 'border-indigo-500 ring-1 ring-indigo-500' : 'border-slate-200 dark:border-zinc-700 hover:border-indigo-300 dark:hover:border-indigo-700'} rounded-sm p-2 transition-all cursor-pointer hover:shadow-md flex flex-col gap-1 min-h-[80px]`}
                                            >
                                                    ...
                                                    {slotAppointments.map(appt => {
                                                        ...
                                                        return (
                                                            <div
                                                                ...
                                                                className={`absolute left-1 right-1 z-10 group p-1.5 rounded-sm border text-left cursor-pointer transition-all hover:z-[100] active:scale-95 shadow-sm ${appt.status === 'Confirmado' ? 'bg-emerald-50 dark:bg-emerald-900/20 border-emerald-200 dark:border-emerald-800 hover:border-emerald-300' :
                                                            ...
                                                            >
                                                                ...
                                                                {/* HOVER TOOLTIP */}
                                                                <div className="absolute opacity-0 group-hover:opacity-100 pointer-events-none z-[999] top-4 left-full ml-2 w-80 bg-white dark:bg-zinc-900 border-2 border-slate-900 dark:border-zinc-700 rounded-sm shadow-2xl p-4 animate-in fade-in slide-in-from-left-2 duration-200 hidden md:block">
                ...
                {isCustomerSelectionOpen && (
                    <div className="fixed inset-0 bg-black/60 z-[100] flex items-center justify-center p-4 backdrop-blur-sm">
                        <div className="bg-white dark:bg-zinc-900 rounded-sm shadow-2xl w-full max-w-lg overflow-hidden animate-in zoom-in duration-200 border-2 border-slate-900 dark:border-zinc-700 flex flex-col max-h-[80vh]">
                                ...
                                <div className="p-4 bg-indigo-50 dark:bg-zinc-900 border-b border-indigo-100 dark:border-zinc-800 animate-in slide-in-from-top-2">
                                    ...
                                    <form onSubmit={handleQuickRegister} className="flex flex-col gap-3">
                                        <input
                                            ...
                                            className="w-full px-3 py-2 rounded-sm border border-indigo-100 dark:border-zinc-700 text-xs font-bold focus:outline-none focus:border-indigo-500 uppercase"
                ...
                {isWhatsAppModalOpen && (
                    <div className="fixed inset-0 bg-black/80 z-[60] flex items-center justify-center p-4 backdrop-blur-sm">
                        <div className="bg-slate-100 dark:bg-zinc-900 rounded-sm shadow-2xl w-full max-w-lg overflow-hidden animate-in zoom-in duration-200 border-2 border-slate-900 dark:border-zinc-700 flex flex-col max-h-[85vh]">
