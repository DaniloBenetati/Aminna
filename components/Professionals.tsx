...
export const Professionals: React.FC<ProfessionalsProps> = ({ appointments, setAppointments, customers, services }) => {
                            ...
                            {weekDays.map(day => (
                                <div 
                                    ...
                                    className={`w-4 h-4 rounded-full flex items-center justify-center text-[7px] font-bold ${
                                        provider.workDays?.includes(day.id) 
                                ...
                                {weekDays.map(day => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`flex-1 py-3 rounded-xl border-2 transition-all text-sm font-black uppercase ${
                                                isSelected 
