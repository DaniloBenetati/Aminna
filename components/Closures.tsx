...
import { PROVIDERS, CUSTOMERS } from '../constants';
...
export const Closures: React.FC<ClosuresProps> = ({ services, appointments }) => {
  ...
  }, [selectedProvider, searchTerm, startDate, endDate, services, appointments]);
