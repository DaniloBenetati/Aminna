                      ...
                      <div className="p-4 rounded-3xl flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 group bg-slate-50/30 dark:bg-zinc-800/20 border border-slate-100 dark:border-zinc-800/50">
                        <div className="flex gap-4 items-center min-w-0 w-full sm:w-auto">
                          ...
                          <div className="min-w-0 flex-1">
                            <div className="flex flex-col md:flex-row md:items-center gap-x-3 gap-y-1">
                              <p className="font-black text-slate-950 dark:text-white text-base leading-tight truncate">{p.name}</p>
                              <div className="flex gap-1.5 overflow-x-auto scrollbar-hide">
                                <span className={`text-[10px] px-2 py-1 rounded-full font-black uppercase border whitespace-nowrap ${p.partnershipType === 'PERMUTA' ? 'bg-purple-50 text-purple-800 border-purple-200' : 'bg-emerald-50 text-emerald-800 border-emerald-200'}`}>{p.partnershipType}</span>
                                <span className="text-[10px] text-slate-600 font-black uppercase tracking-tighter border border-slate-200 px-2 py-1 rounded-full whitespace-nowrap bg-slate-50">{p.category}</span>
                                {p.thermometer && (
                                  <span className={`text-[10px] px-2 py-1 rounded-full font-black uppercase border whitespace-nowrap ${
                              ...
                              <div className="mt-2 flex flex-col gap-1 px-1">
                                {p.contractScope && (
                                  <div className="flex items-start gap-2">
                                    ...
                                    <p className="text-[11px] text-slate-500 font-bold leading-tight line-clamp-2">{p.contractScope}</p>
                                  </div>
                                )}
                                {p.contractUrl && (
                                  <a 
                                    ...
                                    className="flex items-center gap-2 text-[11px] text-indigo-600 font-black hover:underline w-fit"
                                  >
                        ...
                        {p.linkedCustomerId && (
                          <div className="flex-1 min-w-[140px] border-l border-slate-100 dark:border-zinc-800/50 pl-4 hidden md:block">
                            <div className="flex items-center gap-1 mb-1.5 uppercase tracking-widest text-slate-400 font-black text-[10px]">
                            ...
                            <div className="flex flex-wrap gap-2">
                                ...
                                .map(appt => {
                                  ...
                                  return (
                                    <div key={appt.id} className="inline-flex items-center gap-2 p-1.5 bg-white dark:bg-zinc-800/40 rounded-xl border border-slate-100 dark:border-zinc-700/50 shadow-sm relative pr-3">
                                      ...
                                      <div className="min-w-0">
                                        <p className="text-[10px] font-black text-slate-950 dark:text-white truncate uppercase max-w-[80px] leading-none mb-1">{srv?.name || 'Serviço'}</p>
                                        <p className="text-[9px] font-bold text-slate-500 leading-none">{appt.time}</p>
                                      </div>
                              ...
                              {appointments.filter(a => a.customerId === p.linkedCustomerId && a.date >= new Date().toISOString().split('T')[0] && (a.status === 'Confirmado' || a.status === 'Pendente' || a.status === 'Em atendimento')).length === 0 && (
                                <p className="text-[10px] font-black text-slate-400 italic uppercase">Sem agendamentos</p>
                              )}
                            </div>
                          </div>
                        )}
                            ...
                            <div key={c.id} className="bg-white dark:bg-zinc-800/50 p-4 rounded-2xl border border-slate-100 dark:border-zinc-700 shadow-sm flex flex-col gap-3 group/coupon">
                              <div className="flex justify-between items-start">
                                ...
                                <div className="flex gap-1 opacity-0 group-hover/coupon:opacity-100 transition-opacity">
                                  ...
                                  <button onClick={() => handleDeleteCampaign(c.id)} className="p-1 text-slate-400 hover:text-rose-600"><Trash2 size={16} /></button>
                                </div>
                              </div>
                              <div className="flex flex-wrap gap-2">
          ...
          <div className="flex flex-wrap items-center gap-4 bg-white dark:bg-zinc-900 p-4 rounded-3xl border border-slate-200 dark:border-zinc-800 shadow-sm">
             <div className="flex items-center gap-2 px-2">
               ...
               <input 
                 ...
                 className="bg-transparent text-xs font-black uppercase outline-none focus:text-indigo-600 dark:text-white cursor-pointer"
               />
               <span className="text-xs font-black text-slate-300 uppercase tracking-widest">até</span>
               <input 
                 type="date" 
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="bg-white dark:bg-zinc-900 p-6 rounded-[2rem] border border-slate-200 dark:border-zinc-800 shadow-sm">
              ...
              <div className="mt-2 flex items-center gap-1">
                <span className="text-[10px] font-bold text-emerald-600 bg-emerald-50 px-1.5 py-0.5 rounded-full">Impacto Total</span>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-zinc-900 p-6 rounded-[2rem] border border-slate-200 dark:border-zinc-800 shadow-sm">
              ...
              <div className="mt-2 flex items-center gap-1">
                <span className="text-[10px] font-bold text-indigo-600 bg-indigo-50 px-1.5 py-0.5 rounded-full">Novos & Recorrentes</span>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-zinc-900 p-6 rounded-[2rem] border border-slate-200 dark:border-zinc-800 shadow-sm">
              ...
              <div className="mt-2 flex items-center gap-1">
                <span className="text-[10px] font-bold text-rose-600 bg-rose-50 px-1.5 py-0.5 rounded-full">Mês Atual</span>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-zinc-900 p-6 rounded-[2rem] border border-slate-200 dark:border-zinc-800 shadow-sm">
              ...
              <div className="mt-2 flex items-center gap-1">
                <span className="text-[10px] font-bold text-amber-600 bg-amber-50 px-1.5 py-0.5 rounded-full">Lucro / Invest.</span>
              </div>
            </div>
          </div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="bg-slate-50 dark:bg-zinc-800/50">
                    <th className="px-6 py-4 text-left text-[11px] font-black text-slate-500 uppercase tracking-widest">Campanha / Parceiro</th>
                    <th className="px-6 py-4 text-center text-[11px] font-black text-slate-500 uppercase tracking-widest">Atendimentos</th>
                     <th className="px-6 py-4 text-right text-[11px] font-black text-slate-500 uppercase tracking-widest">Faturamento</th>
                    <th className="px-6 py-4 text-right text-[11px] font-black text-slate-500 uppercase tracking-widest">Investimento</th>
                    <th className="px-6 py-4 text-right text-[11px] font-black text-slate-500 uppercase tracking-widest">Ticket Médio</th>
                    <th className="px-6 py-4 text-right text-[11px] font-black text-slate-500 uppercase tracking-widest">ROI</th>
                    <th className="px-6 py-4 text-right text-[11px] font-black text-slate-500 uppercase tracking-widest">Status</th>
                  </tr>
                </thead>
                      ...
                      <tr key={c.id} className="hover:bg-slate-50 dark:hover:bg-zinc-800/30 transition-colors">
                        ...
                        <td className="px-6 py-4 text-right">
                          <div className="flex justify-end">
                            <span className={`text-xs font-black tracking-tighter px-2.5 py-1 rounded-full ${
                        ...
                        <td className="px-6 py-4 text-right">
                          <span className={`text-[10px] font-black uppercase px-2 py-1 rounded-full ${c.useCount >= c.maxUses ? 'bg-rose-50 text-rose-600 border border-rose-100' : 'bg-emerald-50 text-emerald-600 border border-emerald-100'}`}>
